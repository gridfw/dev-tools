var PluginError, cliTable, coffeescript, compileCoffee, errorHandler, gulp, gutil, include, settings, template, uglify, watch;
...
compileCoffee = function() {
  ...
  glp = gulp.src("assets/**/*.coffee").pipe(include({
    hardFail: true
  // convert to js
  })).pipe(template()).pipe(coffeescript({
    bare: true
